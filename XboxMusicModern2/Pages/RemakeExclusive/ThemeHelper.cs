...
public static class ThemeHelper
{
    ...
    public static ElementTheme ActualTheme
    {
        get
        {
            ...
            return XboxMusic.App.GetEnum<ElementTheme>(App.Current.RequestedTheme.ToString());
        }
    }
    ...
    public static void Initialize()
    {
        ...
        if (savedTheme != null)
        {
            RootTheme = XboxMusic.App.GetEnum<ElementTheme>(savedTheme);
        }
